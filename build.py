...
# Compile command
compile_line = os.system("clang++ main.cpp -o sound -I/opt/homebrew/opt/sfml/include -L/opt/homebrew/opt/sfml/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio")
